...
[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-Visit_Now-blue?style=for-the-badge)](http://project-management-app-12847.s3-website-us-east-1.amazonaws.com)
[![AWS](https://img.shields.io/badge/AWS-Powered-orange?style=for-the-badge&logo=amazon-aws)](https://aws.amazon.com)
[![Built with Q](https://img.shields.io/badge/Built_with-Amazon_Q-purple?style=for-the-badge)](https://aws.amazon.com/q/developer/)
...
```mermaid
graph LR
    A[Plan Agent] --> B[Context Memory]
    B --> C[Human Alignment]
    C --> D[Approved Documents]
```
...
```mermaid
graph LR
    A[Change Agent] --> B[Revision Tool]
    B --> C[QA Agent]
    C --> A
```
