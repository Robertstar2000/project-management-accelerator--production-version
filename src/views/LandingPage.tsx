...
const Instructions = () => (
    <section className="instructions-list">
        ...
        <ul>
            ...
            <li><strong>Automate Task Execution:</strong> Enable agentic AI to autonomously complete non-physical tasks. A three-agent workflow (Doer, Tools, Tester) collaborates to create deliverables, access project documents, and verify completion—freeing your team to focus on high-value work.</li>
            ...
            <li><strong>Deploy Changes Intelligently:</strong> Use the agentic change management engine to automatically propagate changes across all project documents. The system reviews every document, identifies minimal required updates, and applies changes while maintaining project integrity.</li>
